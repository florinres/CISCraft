...
public partial class AroundTheEdgeBus : UserControl
{
    public static readonly DependencyProperty WrapWidthProperty =
        DependencyProperty.Register(nameof(WrapWidth), typeof(double), typeof(StraightLineBus), new PropertyMetadata(300.0));

    public static readonly DependencyProperty WrapHeightProperty =
        DependencyProperty.Register(nameof(WrapHeight), typeof(double), typeof(StraightLineBus), new PropertyMetadata(300.0));
    
    public static readonly DependencyProperty LineThicknessProperty =
        DependencyProperty.Register(nameof(LineThickness), typeof(double), typeof(StraightLineBus), new PropertyMetadata(6.0));
