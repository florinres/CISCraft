namespace MainMemory.Business
{
    public class MainMemoryModule
    {
        ...
        private static MainMemoryModule mainMemoryInstance;
        private static readonly object _lock = new object();
        private MainMemoryModule()
        {
